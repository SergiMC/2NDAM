...
public class Timoner extends Tripulant {
	...
	protected Timoner (String ID, String nom, boolean actiu, LocalDateTime dataAlta, int departament, int llocDeServei, boolean serveiEnElPont, String descripcioFeina){
