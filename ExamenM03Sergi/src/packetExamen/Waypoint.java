...
public class Waypoint {
	...
	public static ComprovacioRendiment comprovarRendimentInicialitzacio(int numObjACrear, ComprovacioRendiment comprovacioRendimentTmp) {
		...
		for(int i = 0; i < numObjACrear; i++) {
			...
			//SOLUCIÓ:
			comprovacioRendimentTmp.llistaArrayList.add(new Waypoint_Dades(0, "Òrbita de la Terra", new int[] {0,0,0}, true,
					LocalDateTime.parse("21-10-2020 01:10", Data.formatter), null,
					LocalDateTime.parse("22-10-2020 23:55", Data.formatter), 0));
			
			comprovacioRendimentTmp.llistaArrayList.add(new Waypoint_Dades(1, "Punt Lagrange Terra-LLuna", new int[] {1,1,1}, true,
					LocalDateTime.parse("21-10-2020 01:00", Data.formatter), null,
					LocalDateTime.parse("22-10-2020 23:55", Data.formatter),6));
			
			comprovacioRendimentTmp.llistaArrayList.add(new Waypoint_Dades(2, "Òrbita de la LLuna", new int[] {2,2,2}, true,
					LocalDateTime.parse("21-10-2020 00:50", Data.formatter), null,
					LocalDateTime.parse("22-10-2020 23:55", Data.formatter),1));
			
			comprovacioRendimentTmp.llistaArrayList.add(new Waypoint_Dades(3, "Òrbita de Mart", new int[] {3,3,3}, true,
					LocalDateTime.parse("21-10-2020 00:40", Data.formatter), null,
					LocalDateTime.parse("22-10-2020 23:55", Data.formatter),0));
			
			comprovacioRendimentTmp.llistaArrayList.add(new Waypoint_Dades(4, "Òrbita de Júpiter", new int[] {4,4,4}, true,
			...
			comprovacioRendimentTmp.llistaArrayList.add(new Waypoint_Dades(6, "Òrbita de Europa", new int[] {6,6,6}, true,
					LocalDateTime.parse("21-10-2020 00:10", Data.formatter), null,
					LocalDateTime.parse("22-10-2020 23:55", Data.formatter),0));
			
			comprovacioRendimentTmp.llistaArrayList.add(new Waypoint_Dades(7, "Òrbita de Venus", new int[] {7,7,7}, true,
	...
	public static ComprovacioRendiment comprovarRendimentInsercio(ComprovacioRendiment comprovacioRendimentTmp) {
		...
		tempsInicial = System.nanoTime();
		comprovacioRendimentTmp.llistaArrayList.add(0, "Òrbita de la Terra", new int[] {0,0,0}, true,
				LocalDateTime.parse("21-10-2020 01:10", Data.formatter), null,
				LocalDateTime.parse("22-10-2020 23:55", Data.formatter), 0);
		tempsFinal = System.nanoTime();
		...
		tempsInicial = System.nanoTime();
		comprovacioRendimentTmp.llistaLinkedList.add(0, "Òrbita de la Terra", new int[] {0,0,0}, true,
				LocalDateTime.parse("21-10-2020 01:10", Data.formatter), null,
				LocalDateTime.parse("22-10-2020 23:55", Data.formatter), 0);
		tempsFinal = System.nanoTime();
		...
		tempsInicial = System.nanoTime();
		comprovacioRendimentTmp.llistaLinkedList.add(meitatLLista, new Waypoint_Dades(0, "Òrbita de la Terra", new int[] {0,0,0}, true,
				LocalDateTime.parse("21-10-2020 01:10", Data.formatter), null,
				LocalDateTime.parse("22-10-2020 23:55", Data.formatter), 0));
		tempsFinal = System.nanoTime();
		...
		tempsInicial = System.nanoTime();
		comprovacioRendimentTmp.llistaArrayList.add(comprovacioRendimentTmp.llistaArrayList.size(), new Waypoint_Dades(0, "Òrbita de la Terra", new int[] {0,0,0}, true,
				LocalDateTime.parse("21-10-2020 01:10", Data.formatter), null,
				LocalDateTime.parse("22-10-2020 23:55", Data.formatter), 0));
		tempsFinal = System.nanoTime();
		...
		tempsInicial = System.nanoTime();
		comprovacioRendimentTmp.llistaLinkedList.add(comprovacioRendimentTmp.llistaLinkedList.size(), new Waypoint_Dades(0, "Òrbita de la Terra", new int[] {0,0,0}, true,
				LocalDateTime.parse("21-10-2020 01:10", Data.formatter), null,
				LocalDateTime.parse("22-10-2020 23:55", Data.formatter), 0));
		tempsFinal = System.nanoTime();
